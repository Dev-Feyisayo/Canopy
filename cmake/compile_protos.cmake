...
# This script discovers and compiles all .proto files in a directory
# It also generates a cmake file listing all expected .pb.cc files
# Usage:
#   - Compile and generate cmake file: cmake -D PROTOC=<path> -D PROTO_DIR=<dir> -D OUTPUT_DIR=<dir> -D PROTO_SOURCES_CMAKE=<output_file> -P compile_protos.cmake
#   - Only generate cmake file (no compilation): cmake -D PROTO_DIR=<dir> -D PROTO_SOURCES_CMAKE=<output_file> -P compile_protos.cmake
...
if(PROTOC)
    ...
    # Get the parent directories for imports
    # We need to go up from protobuf/ to src/ to get access to all module directories
    ...
    foreach(PROTO_FILE ${PROTO_FILES})
        ...
        # Run protoc with src directory as the single proto_path
        # All imports in .proto files use full paths relative to src directory
        execute_process(
            COMMAND ${PROTOC}
            --proto_path=${PROTO_SRC_DIR}
            --cpp_out=${OUTPUT_DIR}
...
# Generate the cmake file with PROTO_PB_SOURCES
# Use PROTO_SOURCES_CMAKE if provided, otherwise use default location
