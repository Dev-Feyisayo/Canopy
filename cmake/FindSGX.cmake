...
if(SGX_FOUND)
  ...
  function(
    ...
    target_include_directories(
      ...
      PRIVATE ${INCLUDE_PATHS} ${CANOPY_ENCLAVE_LIBCXX_INCLUDES})
    ...
    target_link_libraries(${target} PRIVATE ${edl_link_libraries} # ${SGX_LINKER_FLAGS}
    )
    target_compile_definitions(${target} PRIVATE ${CANOPY_ENCLAVE_DEFINES})
    target_compile_options(${target} PRIVATE ${CANOPY_ENCLAVE_COMPILE_OPTIONS})
  ...
  function(
    ...
    add_custom_target(${target}-create-header ALL DEPENDS ${EDL_UT_H}) # Used to avoid problems when in cyclic
                                                                       # references e.g.
    # add_dependencies(runtime_edl secretarium_bft_raft_edl-create-header)
    ...
    target_compile_options(${target} PRIVATE ${CANOPY_COMPILE_OPTIONS})
