...
**Problem**: Standard `dynamic_pointer_cast` only works with local C++ objects, but Canopy needs to support casting across distributed object boundaries.
