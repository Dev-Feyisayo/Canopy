...
public:
    ...
    CORO_TASK(bool) CoroSetUp()
    {
        ...
        auto child_transport = std::make_shared<rpc::local::child_transport>("main child",
            root_service_,
            new_zone_id,
            rpc::local::parent_transport::bind<yyy::i_host, yyy::i_example>(new_zone_id,
    ...
    CORO_TASK(rpc::shared_ptr<yyy::i_example>) create_new_zone()
    {
        ...
        auto child_transport = std::make_shared<rpc::local::child_transport>("main child",
            root_service_,
            zone_id,
            rpc::local::parent_transport::bind<yyy::i_host, yyy::i_example>(zone_id,
                [&](const rpc::shared_ptr<yyy::i_host>& host,
                    rpc::shared_ptr<yyy::i_example>& new_example,
                    const std::shared_ptr<rpc::child_service>& child_service_ptr) -> CORO_TASK(int)
                {
